...
<head>
  ...
  <link href="/chatApp/chat.css" type="text/css" rel="stylesheet">
...
<body>
  ...
  {{-- </div> --}}
  <div id="appChat" class="container">
        ...
        <div class="mesgs">
          ...
          <div class="type_msg">
            <div class="input_msg_write">
              <input v-model="tinNhan" @keyup.enter="guiTinnhan" type="text" class="write_msg" placeholder="Type a message" />
              <button @click="guiTinnhan" class="msg_send_btn" type="button"><i class="fa fa-paper-plane-o" aria-hidden="true"></i></button>
            </div>
          </div>
        </div>
      </div>
